...
import HandleTrueCallerLogin from './hooks/HandleTrueCallerLogin';
...
export default {
    before: {
        ...
        get: [],
        create: [
            FRequired(['accessToken', 'entityId', 'deviceType', 'deviceId', 'ip']),
            SetDefaultItem('authService', AuthServiceType.trueCaller),
